#ifndef EventFilter_CSCRawToDigi_CSCTMBHeader2020_GEM_h
#define EventFilter_CSCRawToDigi_CSCTMBHeader2020_GEM_h
#include "EventFilter/CSCRawToDigi/interface/CSCVTMBHeaderFormat.h"
#include "DataFormats/MuonDetId/interface/CSCDetId.h"

struct CSCTMBHeader2020_GEM : public CSCVTMBHeaderFormat {
  enum { NWORDS = 43 };
